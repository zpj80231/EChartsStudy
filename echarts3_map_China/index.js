...
function setMapData(){
    ...
    //[{name:'被攻击地'}, {name:'攻击地',value:攻击次数}],
        ...
        [{name:'北京'}, {name:'拉萨',value:30}],
        [{name:'北京'},{name:'兰州',value:30}],
        [{name:'北京'}, {name:'太原',value:30}],
        [{name:'北京'}, {name:'昌都',value:30}],
        [{name:'北京'}, {name:'成都',value:30}]       
    ];
    ...
    [['北京', longNanData]].forEach(function (item, i) {
    	console.log(item);console.log(i);
        series.push(
        {
            name: '去往：' +item[0],  //line
            type: 'lines',
